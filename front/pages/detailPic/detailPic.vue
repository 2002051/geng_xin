<template>
    <view class="album-detail-container">
        ...
        <!-- 相册头部信息 -->
        <view class="album-header" :class="{'with-cover': album.cover_photo && album.cover_photo.image_url}">
            <!-- 封面背景图 -->
            <image 
        ...
        <view class="photo-section">
            ...
            <view v-if="photoList.length > 0" class="photo-grid">
                ...
                >
                    ...
                    <view v-if="selectionMode" class="selection-marker" 
                        ...
                        <uni-icons v-if="selectedPhotos.includes(photo.id)" 
            ...
            <view v-if="photoList.length > 0 && photoHasMore">
                <uni-load-more 
                    :status="photoLoadMoreStatus" 
                    @clickLoadMore="loadMorePhotos"
                ></uni-load-more>
            </view>
        </view>
        ...
        <view v-if="!selectionMode" class="bottom-action-bar">
            ...
            <button class="upload-fab" @click="uploadPhotos">
                <uni-icons type="camera-filled" size="36" color="#fff"></uni-icons>
            </button>
        </view>
